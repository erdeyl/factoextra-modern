.onAttach <- function(libname, pkgname) {
  packageStartupMessage("Welcome to factoextraplus! ggpubrplus and FactoMineR have been loaded.")
  ...
  if (dir.exists(lock_dir)) {
    packageStartupMessage(
      ...
      "This may cause installation issues. Run factoextraplus::clean_lock_files() to remove it."
    )
  }
}
...
#'   Default is "factoextraplus". Use "all" to remove all lock files.
...
#'
#' @export
clean_lock_files <- function(package = "factoextraplus", lib = .libPaths()[1], ask = TRUE) {
